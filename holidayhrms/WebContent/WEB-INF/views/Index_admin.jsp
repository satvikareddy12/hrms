      ...
      <div class="menu-content">
        <ul class="menu-items">
          ...
          <li class="item">
           ...
           <li class="item">
            <a href="#"><i class="ri-bar-chart-line"></i> Candidates</a>
          </li>
          ...
          <li class="item">
            ...
            <ul class="menu-items submenu">
              ...
              <a href="javascript:void(0)"  onclick="getHolidays();"><i class="ri-calendar-line"></i> Provided</a>
               ...
               <li class="item">
                <a href="javascript:void(0)"  onclick="getyourtHolidays();"><i class="ri-file-list-line"></i> Issue</a>
              </li>
           ...
           <li class="item">
            <a href="#"><i class="ri-bar-chart-line"></i> Induction</a>
          </li>
